...
<div class="notification-inner">
    <div class="notification-header">
        ...
        <a href="<?php echo BASE_URL.$data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> Followed you your - <span><?php echo $getFromU->timeAgo(BASE_URL.$data->time);?></span>
...
<div class="notification-inner">
    ...
    <div class="notification-tweet"> 
        <a href="../<?php echo $data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> liked your TWEET - <?php if($data->tweetBy === $user_id){echo 'Tweet';}else{echo 'Retweet';} ?> - <span><?php echo $getFromU->timeAgo(BASE_URL.$data->time);?></span>
    </div>
    <div class="notification-footer">
        <div class="noti-footer-inner">
            <div class="noti-footer-inner-left">
                <div class="t-h-c-name">
                    <span><a href="../<?php echo $user->username;?>"><?php echo $user->screenName;?></a></span>
                    <span>@<?php echo $user->username;?></span>
                    <span><?php echo $getFromU->timeAgo(BASE_URL.$data->time);?></span>
                </div>
...
<div class="notification-inner">
    ...
    <div class="notification-tweet"> 
        <a href="<?php echo BASE_URL.$data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> retweet your <?php if($data->tweetBy === $user_id){echo 'Tweet';}else{echo 'Retweet';} ?> - <span><?php echo $getFromU->timeAgo(BASE_URL.$data->time);?></span>
    </div>
    <div class="notification-footer">
        <div class="noti-footer-inner">
            ...
            <div class="noti-footer-inner-left">
                <div class="t-h-c-name">
                    <span><a href="<?php echo BASE_URL.$user->username;?>"><?php echo BASE_URL.$user->screenName;?></a></span>
                    <span>@<?php echo $user->username;?></span>
