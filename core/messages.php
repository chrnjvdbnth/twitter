...
<div class="message-send">
		...
		<div class="message-recent">
			...
			<div class="people-message" data-user="<?php echo $message->user_id;?>">
				<div class="people-inner">
					...
					<span>
                    <?php echo $getFromU->timeAgo($message->profileImage);?>
					</span>
				</div>
			</div>
            <!--Direct Messages-->
	...
	<div class="back">
		...
		<div class="back-inner">
            ...
            <?php foreach($messages as $message) : ?>
			<!--Direct Messages-->
				<div class="people-message" <?php echo $message->user_id;?> >
					<div class="people-inner">
						<div class="people-img">
							<img src="<?php echo BASE_URL.$message->profileImage;?>"/>
						</div>
						<div class="name-right2">
							<span><a href="#"><?php echo $message->username;?></a></span><span>@USERNAME</span>
						</div>
						<div class="msg-box">
